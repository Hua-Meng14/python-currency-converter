...
class Main(tk.Tk):
    ...
    def __init__(self, converter):
        tk.Tk.__init__(self)
        self.title('GM Currency Converter')
        self.geometry('400x400')
        self.config(bg='#fcba03')
        self.CurrencyConverter = converter

        # Create title label
        self.title_label = Label(self, text='GM Currency Converter', bg='#e3ca84', fg='black', font=('franklin gothic medium', 20), relief='sunken')
        self.title_label.place(x=200, y=35, anchor='center')

        # Create date label
        self.date_label = Label(self, text=f'{dt.datetime.now():%A, %B %d, %Y}', bg='#e3ca84', fg='black', font=('calibri', 10))
        self.date_label.place(x=0, y=400, anchor='sw')

        # Create version label
        self.version_label = Label(self, text='v2.0', bg='#e3ca84', fg='black', font=('calibri', 10))
        self.version_label.place(x=400, y=400, anchor='se')

        # Create amount label
        self.amount_label = Label(self, text='Input Amount: ', bg='#e3ca84', fg='black', font=('franklin gothic book', 15))
        ...
        # Create 'from' label
        self.base_currency_label = Label(self, text='From: ', bg='#e3ca84', fg='black', font=('franklin gothic book', 15))
        self.base_currency_label.place(x=200, y=140, anchor='center')

        # Create 'to' label
        self.destination_currency_label = Label(self, text='To: ', bg='#e3ca84', fg='black', font=('franklin gothic book', 15))
        ...
        self.currency_variable2.set('KHR')
        ...
        self.convert_button = Button(self, text='Convert', bg='#7bd18f', fg='black', command=self.processed)
        ...
        self.final_result = Label(self, text='', bg='#52595D', fg='white', font=('calibri', 15), relief='sunken', width=40)
